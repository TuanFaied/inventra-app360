              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  ...
                  colorFilter: ColorFilter.mode(
                    const Color(0xffe1e4e8).withOpacity(0.2), // Replace with your desired color and opacity
                    BlendMode.srcATop,
                  ),
                ),
              ),
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return Padding(
                            ...
                            child: RouteCard(routeName: routes[index].route, routeId: routes[index].id, user: user, route: routes[index]),
                          );
                        },
                      ),
                    ),
